...
map("n", "<leader>r", ":MagmaEvaluateOperator<CR>", { silent = true })
...
vim.keymap.set("n", "<leader>bq", require("bqls_viewer").run, { desc = "Run BigQuery query" })
