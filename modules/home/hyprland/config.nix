  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bind = [
        ...
        # "$mainMod SHIFT, U, exec, hyprctl dispatch exec '[float; size 800 900; center] ghostty -e sh -c \"bash ~/.dotfiles/scripts/logs.sh; read -p \\\"Press Enter to close...\\\"\"'"
        "$mainMod SHIFT, U, exec, ghostty --class=\"floating\" -e sh -c \"echo hello; read\""
