    ...
    settings = {
      ...
      animations = {
        ...
        animation = [
          ...
          # Windows
          "windowsIn,   1, 1, easeOutCubic,  popin 20%" # window open
          "windowsOut,  1, 1, fluent_decel,  popin 80%" # window close.
          "windowsMove, 1, 1, fluent_decel, slide" # everything in between, moving, dragging, resizing.
          ...
          "fadeShadow,  1, 1,  easeOutCirc" # fade on changing activewindow for shadows
          "fadeDim,     1, 1,   fluent_decel" # the easing of the dimming of inactive windows
          # "border,      1, 2.7, easeOutCirc"  # for animating the border's color switch speed
          # "borderangle, 1, 30,  fluent_decel, once" # for animating the border's gradient angle - styles: once (default), loop
          "workspaces,  1, 1,   easeOutCubic, fade" # styles: slide, slidevert, fade, slidefade, slidefadevert
        ];
      };
      ...
      bind = [
        ...
        "ALT, 1, movetoworkspacesilent, 1" # movetoworkspacesilent
      ...
      # layerrule
      layerrule = [
        "blur, ignore_alpha 0.2, match:namespace waybar"
      ];
